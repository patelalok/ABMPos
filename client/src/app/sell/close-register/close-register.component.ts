 ...
 constructor(private sellService: SellService,  private formBuilder: FormBuilder, private dateService: DateService, private toastr: ToastsManager) { }
  ...
  getCloseRegisterDetails() {
    ...
    .subscribe((closeReg: CloseRegisterDto) => {
      ...
      let pendingInvoiceTotal = +this.closeRegisterDto.cashFromPendingInvoice
      +this.closeRegisterDto.creditFromPendingInvoice
      +this.closeRegisterDto.checkFromPendingInvoice
      +this.closeRegisterDto.storeCreditFromPendingInvoice;
      ...
      this.closeRegisterForm.get('profitPercentage').setValue(this.closeRegisterDto.profitPercentage);
...
export class CloseRegisterDto {
  ...
  storeCreditFromPendingInvoice: number;
