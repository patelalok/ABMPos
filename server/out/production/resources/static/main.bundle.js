...
var EmployeeComponent = /** @class */ (function () {
    function EmployeeComponent(employeeService, formBuilder, router, dateServie) {
        this.employeeService = employeeService;
        this.formBuilder = formBuilder;
        this.router = router;
        this.dateServie = dateServie;
    ...
    EmployeeComponent.prototype.onRowSelectFromEmployee = function (event) {
        this.selectedEmployee = event.data;
        this.getEmployeeDetailBy(this.employeeDetailsBy);
        this.setEmployeeDetailsForUpdate();
    };
    EmployeeComponent.prototype.getEmployeeDetailBy = function (employeeDetailsBy) {
    ...
    EmployeeComponent.prototype.getEmployeeClockInDetails = function () {
        var _this = this;
        if (this.selectedEmployee) {
            this.employeeService.getEmployeeClockInDetails(this.selectedEmployee.username, this.dateDto.startDate, this.dateDto.endDate)
                .subscribe(function (clockIn) {
                clockIn.forEach(function (c) {
                    c.onlyDate = __WEBPACK_IMPORTED_MODULE_5_moment__(c.date).format('YYYY-MM-DD');
                    var clockInHourMoment = __WEBPACK_IMPORTED_MODULE_5_moment__["utc"](c.clockIn, "YYYY-MM-DD HH:mm:ss");
                    var clockOutHourMoment = __WEBPACK_IMPORTED_MODULE_5_moment__["utc"](c.clockOut, "YYYY-MM-DD HH:mm:ss");
                    // Please dont move this from here;
                    // KEEP IN MIND SMALL hh MEANS 12 HOUR FORMATE.
                    c.clockIn = __WEBPACK_IMPORTED_MODULE_5_moment__(c.clockIn).format('hh:mm: A');
                    if (c.clockOut != undefined && c.clockOut != NaN) {
                        ...
                        c.clockOut = __WEBPACK_IMPORTED_MODULE_5_moment__(c.clockOut).format('hh:mm: A');
                        var duration = __WEBPACK_IMPORTED_MODULE_5_moment__["duration"](clockOutHourMoment.diff(clockInHourMoment));
                        var totalHours = __WEBPACK_IMPORTED_MODULE_5_moment__["utc"](+duration).format('HH:mm:ss');
                ...
                _this.clockInDto = clockIn;
                _this.clockInDto = _this.clockInDto.slice();
            });
    ...
    EmployeeComponent.prototype.setEmployeeDetailsForUpdate = function () {
    ...
    EmployeeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_app_employee_employee_service__["a" /* EmployeeService */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["FormBuilder"], __WEBPACK_IMPORTED_MODULE_3__angular_router__["Router"], __WEBPACK_IMPORTED_MODULE_4_app_shared_services_date_service__["b" /* DateService */]])
    ], EmployeeComponent);
...
var AddProductComponent = /** @class */ (function () {
    ...
    AddProductComponent.prototype.ngOnInit = function () {
        ...
        this.form = this.formBuilder.group({
            'productNo': [null, [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["Validators"].required]],
    ...
    AddProductComponent.prototype.getAutoGeneratedProductNo = function (event) {
        var _this = this;
        if (event.clientX > 0) {
        ...
        if (productNo) {
            this.productService.getProductDetailsById(productNo)
                ...
                _this.form = _this.formBuilder.group({
                    ...
                    'cost': [_this.currentProduct.cost, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].pattern('^[0-9-.]+$')]],
...
var SaleComponent = /** @class */ (function () {
    ...
    SaleComponent.prototype.submitProduct = function (value) {
        ...
        if (value && value.length > 3) {
            ...
            var product = this.productMap.get(value);
    ...
    SaleComponent.prototype.timeOut = function () {
        var _this = this;
        setTimeout(function () {
            _this.product = null;
            _this.productForSearchBox = null;
        }, 400);
    };
    ...
    SaleComponent.prototype.getProduct = function () {
        ...
        this.productService.getProductDetails()
            ...
            _this.productList.forEach(function (product) {
                ...
                _this.productMap.set(product.productNo, product);
            });
...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        ...
        this.clockInForm.get('username').valueChanges
            .subscribe(function (change) {
            if (null != _this.clockInForm.get('username').value) {
    ...
    HeaderComponent.prototype.getClockInDetails = function () {
        ...
        this.employeeService.getEmployeeClockInDetails(this.clockInObj.username, this.dateDto.startDate, this.dateDto.endDate)
            ...
            if (_this.clockInList && _this.clockInList.length > 0) {
    ...
    HeaderComponent.prototype.validateAndAddClockInDetails = function () {
        ...
        this.employeeService.validateEmployee(this.clockInForm.get('username').value, this.clockInForm.get('password').value)
            ...
            if (valid) {
                ...
                _this.toastr.error("Wrong Credintails, Please Try Again!!", 'Error');
            }
            if (valid && !_this.isClockIn) {
                ...
                var index = _this.employeeDto.findIndex(function (el) { return el.username == username; });
                if (index > -1) {
                    _this.clockInObj.hourlyRate = _this.employeeDto[index].hourlyRate;
                }
    ...
    HeaderComponent.prototype.setClockInListForView = function () {
        ...
        this.clockInList.forEach(function (clockIn) {
            ...
            clockInViewList.clockIn = __WEBPACK_IMPORTED_MODULE_5_moment__(clockIn.clockIn).format('HH:mm A');
            if (clockIn.clockOut != null) {
                clockInViewList.clockOut = __WEBPACK_IMPORTED_MODULE_5_moment__(clockIn.clockOut).format('HH:mm A');
            }
            if (clockIn.clockIn != null && clockIn.clockOut != null) {
                var start = __WEBPACK_IMPORTED_MODULE_5_moment__["utc"](clockIn.clockIn, "YYYY-MM-DD HH:mm:ss");
                var end = __WEBPACK_IMPORTED_MODULE_5_moment__["utc"](clockIn.clockOut, "YYYY-MM-DD HH:mm:ss");
                var duration = __WEBPACK_IMPORTED_MODULE_5_moment__["duration"](end.diff(start));
                var totalHours = __WEBPACK_IMPORTED_MODULE_5_moment__["utc"](+duration).format('HH:mm');
                clockInViewList.noOfHours = totalHours;
            }
            _this.clockInViewList.push(clockInViewList);
            _this.clockInViewList = _this.clockInViewList.slice();
        });
    };
...
var DateService = /** @class */ (function () {
    ...
    DateService.prototype.getCurrentDay = function () {
        this.dateDto = new DateDto();
        this.dateDto.startDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).startOf('day').format('YYYY-MM-DD HH:mm:ss');
        this.dateDto.endDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).endOf('day').format('YYYY-MM-DD HH:mm:ss');
        return this.dateDto;
    };
    DateService.prototype.getPreviousDay = function () {
        this.dateDto = new DateDto();
        this.dateDto.startDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).subtract(1, 'day').startOf('day').format('YYYY-MM-DD HH:mm:ss');
        this.dateDto.endDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).subtract(1, 'day').endOf('day').format('YYYY-MM-DD HH:mm:ss');
        return this.dateDto;
    };
    DateService.prototype.getCurrentWeek = function () {
        this.dateDto = new DateDto();
        this.dateDto.startDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).startOf('isoWeek').format('YYYY-MM-DD HH:mm:ss');
        this.dateDto.endDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).endOf('isoWeek').format('YYYY-MM-DD HH:mm:ss');
        return this.dateDto;
    };
    DateService.prototype.getLastWeek = function () {
        this.dateDto = new DateDto();
        this.dateDto.startDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).subtract(1, 'weeks').startOf('isoWeek').format('YYYY-MM-DD HH:mm:ss');
        this.dateDto.endDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).subtract(1, 'weeks').endOf('isoWeek').format('YYYY-MM-DD HH:mm:ss');
        return this.dateDto;
    };
    DateService.prototype.getLast2Weeks = function () {
        this.dateDto = new DateDto();
        this.dateDto.startDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).subtract(2, 'weeks').startOf('isoWeek').format('YYYY-MM-DD HH:mm:ss');
        this.dateDto.endDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).subtract(1, 'weeks').endOf('isoWeek').format('YYYY-MM-DD HH:mm:ss');
        return this.dateDto;
    };
    DateService.prototype.getLast4Weeks = function () {
        this.dateDto = new DateDto();
        this.dateDto.startDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).subtract(4, 'weeks').startOf('isoWeek').format('YYYY-MM-DD HH:mm:ss');
        this.dateDto.endDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).subtract(1, 'weeks').endOf('isoWeek').format('YYYY-MM-DD HH:mm:ss');
        return this.dateDto;
    };
    DateService.prototype.getCurrentMonth = function () {
        this.dateDto = new DateDto();
        this.dateDto.startDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).startOf('month').format('YYYY-MM-DD HH:mm:ss');
        this.dateDto.endDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).endOf('month').format('YYYY-MM-DD HH:mm:ss');
        return this.dateDto;
    };
    DateService.prototype.getLastMonth = function () {
        this.dateDto = new DateDto();
        this.dateDto.startDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).subtract(1, 'month').startOf('month').format('YYYY-MM-DD HH:mm:ss');
        this.dateDto.endDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).subtract(1, 'month').endOf('month').format('YYYY-MM-DD HH:mm:ss');
        return this.dateDto;
    };
    DateService.prototype.getLast3Months = function () {
        this.dateDto = new DateDto();
        this.dateDto.startDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).subtract(3, 'month').startOf('month').format('YYYY-MM-DD HH:mm:ss');
        this.dateDto.endDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).subtract(1, 'month').endOf('month').format('YYYY-MM-DD HH:mm:ss');
        return this.dateDto;
    };
    DateService.prototype.getLast6Months = function () {
        this.dateDto = new DateDto();
        this.dateDto.startDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).subtract(6, 'month').startOf('month').format('YYYY-MM-DD HH:mm:ss');
        this.dateDto.endDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).subtract(1, 'month').endOf('month').format('YYYY-MM-DD HH:mm:ss');
        return this.dateDto;
    };
    DateService.prototype.getCurrentYear = function () {
        this.dateDto = new DateDto();
        this.dateDto.startDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).startOf('year').format('YYYY-MM-DD HH:mm:ss');
        this.dateDto.endDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).endOf('year').format('YYYY-MM-DD HH:mm:ss');
        return this.dateDto;
    };
    DateService.prototype.getLastYear = function () {
        this.dateDto = new DateDto();
        this.dateDto.startDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).subtract(1, 'year').startOf('year').format('YYYY-MM-DD HH:mm:ss');
        this.dateDto.endDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).subtract(1, 'year').endOf('year').format('YYYY-MM-DD HH:mm:ss');
        return this.dateDto;
    };
    DateService.prototype.getLast5Years = function () {
        this.dateDto = new DateDto();
        this.dateDto.startDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).subtract(5, 'year').startOf('year').format('YYYY-MM-DD HH:mm:ss');
        this.dateDto.endDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).subtract(1, 'year').endOf('year').format('YYYY-MM-DD HH:mm:ss');
        return this.dateDto;
    };
    DateService.prototype.getLast10Years = function () {
        this.dateDto = new DateDto();
        this.dateDto.startDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).subtract(10, 'year').startOf('year').format('YYYY-MM-DD HH:mm:ss');
        this.dateDto.endDate = __WEBPACK_IMPORTED_MODULE_1_moment__(Date.now()).subtract(1, 'year').endOf('year').format('YYYY-MM-DD HH:mm:ss');
        return this.dateDto;
    };
    ...
    SharedModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            exports: [
                ...
                __WEBPACK_IMPORTED_MODULE_6__angular_material__["n" /* MatTabsModule */],
