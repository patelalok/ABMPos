...
var AppComponent = /** @class */ (function () {
    function AppComponent(configService, toastr, vcr, userService) {
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_app_shared_config_service__["a" /* ConfigService */], __WEBPACK_IMPORTED_MODULE_3_ng2_toastr__["ToastsManager"], __WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewContainerRef"], __WEBPACK_IMPORTED_MODULE_4_app_auth_user_user_service__["a" /* UserService */]])
    ], AppComponent);
    return AppComponent;
}());
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_15_app_shared_storesetup_storesetup_service__["a" /* StoreSetupService */], __WEBPACK_IMPORTED_MODULE_20_app_shared_config_service__["a" /* ConfigService */]],
...
var CloseRegisterComponent = /** @class */ (function () {
    ...
    CloseRegisterComponent.prototype.getCloseRegisterDetails = function (startDate, endDate) {
        ...
        this.closeRegisterService.getCloseRegisterDetails(startDate, endDate)
            ...
            _this.closeRegisterForm.get('totalWithoutTax').setValue(_this.closeRegisterDto.reportTotalAmount - _this.closeRegisterDto.tax);
...
var CustomerComponent = /** @class */ (function () {
    ...
    CustomerComponent.prototype.ngOnInit = function () {
        ...
        this.customerForm = this.formBuilder.group({
            ...
            // 'phoneNo': [''],
            'username': [null],
            'email': ['', [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["Validators"].pattern('^[A-Za-z0-9.]+@[A-Za-z0-9.]+$')]],
            'dateOfBirth': [null],
            'taxId': [''],
            'street': [null],
            'zipCode': [''],
...
var AddInventoryComponent = /** @class */ (function () {
    function AddInventoryComponent(saleService, productService, persit) {
    ...
    AddInventoryComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3_app_sell_sell_service__["a" /* SellService */], __WEBPACK_IMPORTED_MODULE_1_app_product_product_service__["a" /* ProductService */], __WEBPACK_IMPORTED_MODULE_4_app_shared_services_persistence_service__["a" /* PersistenceService */]])
        ...
        if (productNo) {
            this.productService.getProductDetailsById(productNo)
                ...
                _this.form = _this.formBuilder.group({
                    ...
                    'quantity': [_this.currentProduct.quantity, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].pattern('^[0-9]+$')]],
                    'minQuantity': [_this.currentProduct.minQuantity, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].pattern('^[0-9]+$')]],
...
var ProductTableComponent = /** @class */ (function () {
    ...
    ProductTableComponent.prototype.getProductDetails = function () {
        ...
        this.productService.getProductDetails('All', 0)
            ...
            _this.productViewList = _this.backendProductDto;
        });
    };
    ...
    ProductTableComponent.prototype.nowFilterProduct = function (input, backendProductDto) {
        var filtered = [];
        for (var i = 0; i < backendProductDto.length; i++) {
            var p = backendProductDto[i];
    ...
    ProductTableComponent.prototype.fiterProductByDropdown = function (obj) {
        ...
        if (this.selectedProductDropdownOption === 'Brand') {
            this.productViewList = this.backendProductDto.filter(function (el) { return el.brandId == obj; });
        }
        else if (this.selectedProductDropdownOption === 'Category') {
            this.productViewList = this.backendProductDto.filter(function (cat) { return cat.categoryId == obj; });
        }
        else if (this.selectedProductDropdownOption === 'Vendor') {
            this.productViewList = this.backendProductDto.filter(function (ven) { return ven.vendorId == obj; });
        }
        else if (this.selectedProductDropdownOption === 'Model') {
            this.productViewList = this.backendProductDto.filter(function (mod) { return mod.modelId == obj; });
        }
    };
    ...
    ProductTableComponent.prototype.setProductInventoryForSelectedProduct = function (productInventoryList1) {
        ...
        productInventoryList1.forEach(function (inventory) {
            inventory.time = __WEBPACK_IMPORTED_MODULE_3_moment__(inventory.createdTimestamp).format('hh:mm A');
            inventory.date = __WEBPACK_IMPORTED_MODULE_3_moment__(inventory.createdTimestamp).format('MM/DD/YYYY');
        });
    ...
    ProductTableComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_app_product_product_service__["a" /* ProductService */]])
...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.getProductDetails = function (getProductBy, searchValue) {
    ...
    SaleComponent.prototype.completeSale = function () {
        ...
        this.sellService.addTransactionDetails(this.transactionDtoList)
            ...
            if (_this.saleType == 'Park') {
                ...
                _this.printTransactionDto = null;
            }
            _this.disableCompleteSaleButton = true;
            console.log('addTransaction response', data);
            console.log('printTransaction dao', _this.printTransactionDto);
...
var SalesHistoryComponent = /** @class */ (function () {
    function SalesHistoryComponent(sellService, fb, dateService, http, toastr) {
        this.sellService = sellService;
        this.fb = fb;
        this.dateService = dateService;
        this.http = http;
    ...
    SalesHistoryComponent.prototype.ngOnInit = function () {
        ...
        this.searchByCustomerInputBox.valueChanges
            ...
            .distinctUntilChanged()
            .subscribe(function (change) {
            _this.filterTransactionDetails(change);
        });
    ...
    SalesHistoryComponent.prototype.filterTransactionDetails = function (input) {
    ...
    SalesHistoryComponent.prototype.nowFilterTransaction = function (query, transactionDetailsList) {
        var filtered = [];
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(employeeService, formBuilder, dateService, userService) {
        this.employeeService = employeeService;
        this.formBuilder = formBuilder;
        this.dateService = dateService;
        this.userService = userService;
    ...
    HeaderComponent.prototype.getClockInDetails = function () {
        ...
        this.employeeService.getEmployeeClockInDetails(this.clockInForm.get('username').value, this.dateDto.startDate, this.dateDto.endDate)
            .subscribe(function (alok) {
            _this.clockInObj = alok;
